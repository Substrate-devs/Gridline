  ...
  return (
    <div className="site-shell" id="top">
      ...
      <main>
        ...
        <section className="mascot-section reveal-on-scroll"><div className="mascot-section-heading"><span className="section-index">THE GRIDLINE CREW</span><h2>Three little guides<br /><em>for the whole build.</em></h2><p>They show up when the work needs a little more context, a sharper next step, or a confident way to ship.</p></div><div className="mascot-grid"><a href="/context" className="mascot-card mascot-card-context"><img src="/manus-storage/gridline-mascot-context_0d909790.png" alt="Context Owl" /><span>01 / Context Owl</span><strong>See the shape.</strong><ArrowUpRight size={15} /></a><a href="/agent" className="mascot-card mascot-card-agent"><img src="/manus-storage/gridline-mascot-agent_64c401a6.png" alt="Agent Fox" /><span>02 / Agent Fox</span><strong>Make intent executable.</strong><ArrowUpRight size={15} /></a><a href="/ship" className="mascot-card mascot-card-ship"><img src="/manus-storage/gridline-mascot-ship_d91f3dc6.png" alt="Ship Swallow" /><span>03 / Ship Swallow</span><strong>Leave a clean trail.</strong><ArrowUpRight size={15} /></a></div></section>
